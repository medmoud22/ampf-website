...
> **ملاحظة:** الصور تُرفع إلى Cloudinary وكل البيانات (الأخبار، المعرض، الأقسام، العيادات، النصوص) وكذلك بيانات تسجيل الدخول محفوظة في Upstash Redis، لذلك كل شيء يبقى بعد إعادة تشغيل Render.
